...
class MainNode(Node):
    ...
    def prepare(self):
        self.node_clients = [_c.layout for _c in self.node_clients]

        self.active_nodes = [c['name'] for c in self.node_clients] if self.active_nodes == None else self.active_nodes
    ...
    def activate_node(self,name):
        ...
        client_names = [c['name'] for c in self.node_clients]
    ...
    def loop(self):
        ...
        nodes_to_loop = [node for node in self.node_clients if node['name'] in self.loop_nodes]
